...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="text-center">Update {{ $data['name']}} Professional</h2>

    <form action="{{ route('Professionals.update', $data['id']) }}" method="POST" class="needs-validation" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            <label for="Image"> Professional Image:</label>
